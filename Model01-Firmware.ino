...
#define BUILD_INFORMATION "bergey 2020-09-03: music pause"
#endif
...
\
  ...
  (M(MACRO_VERSION_INFO),      Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           LockLayer(NUMPAD),
   ...
   Key_Delete, ___, Key_LeftAlt, ___,
   ___,

   Consumer_ScanPreviousTrack, Key_F6,                 Key_F7,                   Key_F8,                   Key_F9,          Key_F10,          Key_F11,
   Consumer_PlaySlashPause,    Consumer_ScanNextTrack, Key_LeftCurlyBracket,     Key_RightCurlyBracket,    Key_LeftBracket, Key_RightBracket, Key_F12,
                               Key_LeftArrow,          Key_DownArrow,            Key_UpArrow,              Key_RightArrow,  Consumer_PlaySlashPause,              ___,
